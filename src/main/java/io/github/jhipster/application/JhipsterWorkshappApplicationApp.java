...
@EnableZuulProxy
public class JhipsterWorkshappApplicationApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterWorkshappApplicationApp.class);

    private final Environment env;

    public JhipsterWorkshappApplicationApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterWorkshappApplication.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterWorkshappApplicationApp.class);
